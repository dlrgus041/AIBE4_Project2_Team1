...
import kr.java.sse_websocket.dto.api.response.LessonDetailResponse;
import kr.java.sse_websocket.dto.api.response.LessonResponse;
import kr.java.sse_websocket.dto.api.request.LessonRequest;
import kr.java.sse_websocket.dto.api.request.LessonUpdateRequest;
import kr.java.sse_websocket.entity.lesson.Lesson;
import kr.java.sse_websocket.entity.user.User;
import kr.java.sse_websocket.repository.LessonRepository;
import kr.java.sse_websocket.repository.TeacherProfileRepository;
import kr.java.sse_websocket.repository.UserRepository;
import kr.java.sse_websocket.search.service.SearchService;
